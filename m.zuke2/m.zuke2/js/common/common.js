    ...
    common.prototype = {
        ...
        /*fontFace: (function() {
            function addFont() {
                ...
                style.textContent = localStorage.PingFangMedium;
                document.head.appendChild(style);
            }
            try {
                if (localStorage.PingFangMedium) {
                    ...
                    xmlHttp.open("GET", "http://m.zuke.com/n/fonts/PingFangMedium/PingFangMedium-woff.css", true);
                    xmlHttp.send();
                    xmlHttp.onreadystatechange = function() {
                        if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                            localStorage.PingFangMedium = xmlHttp.responseText;
                            addFont();
                        }
                    }
                }
        ...
        // 滚动穿透 - 不支持的加个scrollingElement.js
        scrollingElement: (function() {
            ...
            addScript('js/plugins/scrollingelement.js', document.scrollingElement);
        })()
    };
});
// 图片懒加载 扩展jquery插件
                    ...
                    if (o.is(':visible') && (post < 0 && posb > 0) && (posl < 0 && posr > 0)) {
                        if (url) {
                            ...
                            if (tag === "img") {
                                ...
                                //删掉对应data-src
                                callback(o.removeAttr("data-src"));
                            } else {
                                // 设置除img之外元素的背景url

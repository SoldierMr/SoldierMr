$(document).ready(function() {
    ...
    sale.prototype = {
        ...
        getTemplate: function(data) {
            return '<a class="my-box" data-id="' + data.id + '">' +
                '<div href="after_sale_details.html" class="house-box">' +
                '<div class="img-box">' +
                '<img src="' + data.src + '" />' +
                '</div>' +
                ...
                '<p class="f12 mb4 flex"><span class="c-999">补充问题：</span><span class="c-333 flex-hang">' + data.problem + '</span></p>' +
                '<p class="f12 mb4"><span class="c-999">受理时间：</span><span class="c-333">' + data.supply_time + '</span></p>' +
                '<p class="f12 mb4"><span class="c-999">租户反馈：</span><span class="c-333">' + data.fankui + '</span></p>' +
                '</div>' +
                '</a>';
        }
    };

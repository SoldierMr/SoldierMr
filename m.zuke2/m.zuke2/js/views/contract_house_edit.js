    ...
    contract.prototype = {
        ...
        contractSub: (function() {
            ...
            $(".contract-sub").click(function() {
                ...
                supporting = $(".supporting").attr("data-supporting");
                ...
                console.log(courtName, addr, square, houseShi, houseTing, houseWei, supporting, supplyDesc, rent, zuqiStartTime, zuqiMonth, zuqiEndTime, fuzuDay, rentMethod, deposit, renterName, renterPhone, renterId, landlordName, landlordPhone, landlordId);
            });
        })(),
        // 提交成功之后弹出
        subSucc: function() {

    ...
    yuyue.prototype = {
        ...
        getTemplate: function(data) {
            return '<a href="' + data.house_href + '" class="my-box" data-id="' + data.id + '">' +
                ...
                '<p class="f12"><span class="c-999">看房时间：</span><span class="c-333">' + data.time + '</span><span class="c-999 ml20">带看人：</span><span class="c-333">' + data.name + '</span></p>' +
                '</div>' +
                '<div class="score-list-box flex f12">' +
                '<span class="c-999">房源评分：</span><span class="c-3fabfa">' + data.score + '分</span>' +
                '<span class="flex-right">' +
                '<span class="c-999">经纪人综合评分：</span><span class="c-3fabfa">' + data.score + '分</span>' +
                '</span>' +
                '</div>' +
                '</a>';
        }

$(document).ready(function() {
    ...
    houseDetails.prototype = {
        ...
        windowScroll: (function() {
            ...
            $(window).on("scroll", function() {
                if ($(this).scrollTop() > 100) {
                    if (stop) {
                        $(".house-details > .top-fixed").addClass('bg-fff bb-ddd').html('<a href="javascript:history.go(-1)" class="return-icon ml15"></a><span class="f16 c-333 absolute translateHalf">房源详情</span>');
                        stop = false;
                    }
                } else {
                    if (!stop) {
                        $(".house-details > .top-fixed").removeClass('bg-fff bb-ddd').html('<a href="javascript:history.go(-1)" class="return-white-icon ml15"></a>');
                        stop = true;
                    }
                }
            })
        ...
        xqPop: (function() {
            $(".xq").click(function() {
                $(".xq-pop").show();
                houseDetails.prototype.modalHelper.afterOpen();
            });
        })(),
        // 小区详情隐藏
        xqHide: (function() {
            $(".close-xq").click(function() {
                houseDetails.prototype.modalHelper.beforeClose();
                $(".xq-pop").hide();
            });
        })(),
        // 预约看房弹出

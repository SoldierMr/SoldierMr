                ...
                switch (thatParam) {
                    ...
                    case 'district':
                        if (that.hasClass('unlimited')) {
                            window.location.href = "/shop?district=" + encodeURIComponent(that.attr("data-district")) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent($("#station").val()) + "&rentstart=" + encodeURIComponent($("#rentstart").val()) + "&rentend=" + encodeURIComponent($("#rentend").val()) + "&squarestart=" + encodeURIComponent($("#squarestart").val()) + "&squareend=" + encodeURIComponent($("#squareend").val()) + "&characteristic=" + encodeURIComponent($("#characteristic").val()) + "&search=" + encodeURIComponent($("#search").val());
                        } else {
                            $.ajax({
                                url: "/place/region",
                                type: "POST",
                    ...
                    case 'line':
                        if (that.hasClass('unlimited')) {
                            window.location.href = "/shop?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent(that.attr("data-line")) + "&station=" + encodeURIComponent($("#station").val()) + "&rentstart=" + encodeURIComponent($("#rentstart").val()) + "&rentend=" + encodeURIComponent($("#rentend").val()) + "&squarestart=" + encodeURIComponent($("#squarestart").val()) + "&squareend=" + encodeURIComponent($("#squareend").val()) + "&characteristic=" + encodeURIComponent($("#characteristic").val()) + "&search=" + encodeURIComponent($("#search").val());
                        } else {
                            $.ajax({
                                url: "/metro/",
                                type: "POST",
        ...
        rightContentLi: (function() {
            $(document).on('click', '.right-content ul li', function() {
                ...
                switch (thatParam) {
                    // 区域
                    case 'region':
                        window.location.href = "/shop?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent(that.attr("data-region")) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent($("#station").val()) + "&rentstart=" + encodeURIComponent($("#rentstart").val()) + "&rentend=" + encodeURIComponent($("#rentend").val()) + "&squarestart=" + encodeURIComponent($("#squarestart").val()) + "&squareend=" + encodeURIComponent($("#squareend").val()) + "&characteristic=" + encodeURIComponent($("#characteristic").val()) + "&search=" + encodeURIComponent($("#search").val());
                        break;
                        // 地铁站台
                    case 'station':
        ...
        addHouse: (function() {
            ...
            $(".add").click(function() {
                ...
                $.ajax({
                    ...
                    error: function() {
                        shopList.prototype.layerFun("添加失败，请刷新页面");
                    }
                });
            });
        })(),

    ...
    officeList.prototype = {
        ...
        search: (function() {
            $(".search-btn").click(function() {
                window.location.href = "/office?search=" + encodeURIComponent($("#search").val());
            });
        })(),
        // 删除选中房源
        delHouse: (function() {
            ...
            $(".del").click(function() {
                ...
                if (!idArr.length) {
                    officeList.prototype.layerFun("请选择写字楼！");
                    return false;
                }
                ...
                $.ajax({
                    ...
                    error: function() {
                        officeList.prototype.layerFun("删除失败，请刷新页面");
                    }
                });
            });
        })(),
        ...
        getTemplate: function(data) {
            ...
            return '<div class="flex plr12">' +
                ...
                '<p class="c-ff5555 f14">' + parseInt(data.fee_rent) + '元/m²/月</p>' +
                '</div>' +
                '</a>' +
                '</div>';
        }

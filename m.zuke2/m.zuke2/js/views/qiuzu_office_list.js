    ...
    officeList.prototype = {
        ...
        search: (function() {
            $(".search-btn").click(function() {
                window.location.href = "/qiuzu/office?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent($("#station").val()) + "&rent=" + encodeURIComponent($("#rent").val()) + "&square=" + encodeURIComponent($("#square").val()) + "&characteristic=" + encodeURIComponent($("#characteristic").val()) + "&search=" + encodeURIComponent($("#search").val());
            });
        })(),
                ...
                switch (thatParam) {
                    ...
                    case 'district':
                        if (that.hasClass('unlimited')) {
                            window.location.href = "/qiuzu/office?district=" + encodeURIComponent(that.attr("data-district")) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent($("#station").val()) + "&rent=" + encodeURIComponent($("#rent").val()) + "&square=" + encodeURIComponent($("#square").val()) + "&characteristic=" + encodeURIComponent($("#characteristic").val()) + "&search=" + encodeURIComponent($("#search").val());
                        } else {
                            $.ajax({
                                url: "/place/region",
                                type: "POST",
                    ...
                    case 'line':
                        if (that.hasClass('unlimited')) {
                            window.location.href = "/qiuzu/office?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent(that.attr("data-line")) + "&station=" + encodeURIComponent($("#station").val()) + "&rent=" + encodeURIComponent($("#rent").val()) + "&square=" + encodeURIComponent($("#square").val()) + "&characteristic=" + encodeURIComponent($("#characteristic").val()) + "&search=" + encodeURIComponent($("#search").val());
                        } else {
                            $.ajax({
                                url: "/metro/",
                                type: "POST",
        ...
        rightContentLi: (function() {
            $(document).on('click', '.right-content ul li', function() {
                ...
                switch (thatParam) {
                    // 区域
                    case 'region':
                        window.location.href = "/qiuzu/office?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent(that.attr("data-region")) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent($("#station").val()) + "&rent=" + encodeURIComponent($("#rent").val()) + "&square=" + encodeURIComponent($("#square").val()) + "&characteristic=" + encodeURIComponent($("#characteristic").val()) + "&search=" + encodeURIComponent($("#search").val());
                        break;
                        // 地铁站台
                    case 'station':
        ...
        getTemplate: function(data) {
            return '<a href="/qiuzu/office/' + data.lease_id + '.html" class="list-item plr12">' +

    ...
    shopDetails.prototype = {
        ...
        windowScroll: (function() {
            ...
            $(window).on("scroll", function() {
                if ($(this).scrollTop() > 100) {
                    if (stop) {
                        $(".shop-details > .top-fixed").addClass('bg-fff bb-ddd').html('<a href="javascript:history.go(-1)" class="return-icon ml15"></a><span class="f16 c-333 absolute translateHalf">商铺详情</span>');
                        stop = false;
                    }
                } else {
                    if (!stop) {
                        $(".shop-details > .top-fixed").removeClass('bg-fff bb-ddd').html('<a href="javascript:history.go(-1)" class="return-white-icon ml15"></a>');
                        stop = true;
                    }
                }
            })
        ...
        yuyuePop: (function() {
            $(".yuyue-house-btn").click(function(event) {
                $(".yuyue-pop").show();
                shopDetails.prototype.modalHelper.afterOpen();
            });
        })(),
        // 预约看房隐藏
        yuyueHide: (function() {
            $(".close-yuyue").click(function(event) {
                shopDetails.prototype.modalHelper.beforeClose();
                $(".yuyue-pop").hide();
            });
        })(),
        // 选择预约时间

$(document).ready(function() {
    ...
    notice.prototype = {
        ...
        getTemplate: function(data) {
            ...
            return '<div class="my-box">' +
                '<div class="house-top flex align-items-center">' +
                '<p class="f12 red-dot"><span class="c-3fabfa">候鸟</span><span class="c-333">' + data.notice + '</span></p>' +
                '</div>' +
                '<a href="house_details.html" class="house-box">' +
                '<div class="img-box">' +
                '<img src="' + data.lease_image + '" />' +
                '</div>' +
                ...
                '<p class="f12"><span class="c-999">预约时间：</span><span class="c-333">' + data.yuyue_time + '</span></p>' +
                '</div>' +
                '<p class="flex pb12 plr12"><span class="flex-right f12 c-999">' + data.time + '</span></p>' +
                '</div>';
        }
    };
});
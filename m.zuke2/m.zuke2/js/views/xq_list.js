    ...
    xqList.prototype = {
        ...
        search: (function() {
            $(".search-btn").click(function() {
                window.location.href = "/xq?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent($("#station").val()) + "&order=" + encodeURIComponent($("#sort").val()) + "&search=" + encodeURIComponent($("#search").val());
            });
        })(),
                ...
                switch (thatParam) {
                    ...
                    case 'district':
                        if (that.hasClass('unlimited')) {
                            window.location.href = "/xq?district=" + encodeURIComponent(that.attr("data-district")) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent($("#station").val()) + "&order=" + encodeURIComponent($("#sort").val()) + "&search=" + encodeURIComponent($("#search").val());
                        } else {
                            $.ajax({
                                url: "/place/region",
                                type: "POST",
                    ...
                    case 'line':
                        if (that.hasClass('unlimited')) {
                            window.location.href = "/xq?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent(that.attr("data-line")) + "&station=" + encodeURIComponent($("#station").val()) + "&order=" + encodeURIComponent($("#sort").val()) + "&search=" + encodeURIComponent($("#search").val());
                        } else {
                            $.ajax({
                                url: "/metro/",
                                type: "POST",
        ...
        rightContentLi: (function() {
            $(document).on('click', '.right-content ul li', function() {
                ...
                switch (thatParam) {
                    // 区域
                    case 'region':
                        window.location.href = "/xq?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent(that.attr("data-region")) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent($("#station").val()) + "&order=" + encodeURIComponent($("#sort").val()) + "&search=" + encodeURIComponent($("#search").val());
                        break;
                        // 地铁站台
                    case 'station':
                        window.location.href = "/xq?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent(that.attr("data-station")) + "&order=" + encodeURIComponent($("#sort").val()) + "&search=" + encodeURIComponent($("#search").val());
                        break;
                    default:
                        break;
                }
        ...
        contentLi: (function() {
            $(document).on('click', '.criteria-pop > .content ul li', function() {
                ...
                switch (thatParam) {
                    // 排序
                    case 'sort':
                        window.location.href = "/xq?district=" + encodeURIComponent($("#district").val()) + "&region=" + encodeURIComponent($("#region").val()) + "&line=" + encodeURIComponent($("#line").val()) + "&station=" + encodeURIComponent($("#station").val()) + "&order=" + encodeURIComponent(that.attr("data-sort")) + "&search=" + encodeURIComponent($("#search").val());
                        break;
                    default:
                        break;
                }
        ...
        getTemplate: function(data) {
            return '<a href="/xq/' + data.lease_id + '.html" class="list-item plr12">' +
            '<div class="list-img">' +

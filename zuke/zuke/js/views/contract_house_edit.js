    ...
    contract.prototype = {
        ...
        contractSub: (function() {
            ...
            $(".contract-sub").click(function() {
                ...
                console.log(imgArr, courtName, addr, square, houseShi, houseTing, houseWei, supporting, supplyDesc, rent, zuqiStartTime, zuqiMonth, zuqiEndTime, fuzuDay, rentMethod, deposit, renterName, renterPhone, renterId, landlordName, landlordPhone, landlordId);

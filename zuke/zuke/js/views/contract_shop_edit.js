    ...
    contract.prototype = {
        ...
        contractSub: (function() {
            ...
            $(".contract-sub").click(function() {
                ...
                console.log(imgArr, shopName, addr, square, supporting, operationType, supplyDesc, rent, zuqiStartTime, zuqiMonth, zuqiEndTime, fuzuDay, rentMethod, deposit, renterName, renterPhone, renterId, landlordName, landlordPhone, landlordId);

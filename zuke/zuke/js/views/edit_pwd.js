$(document).ready(function() {
    ...
    personal.prototype = {
        ...
        newPwd: function() {
            return $(".edit-line .new-pwd").val();
        },
        pwd: function() {
            return $(".edit-line .pwd").val();
        },
        smsCode: function() {
        ...
        personalSub: (function() {
            ...
            $(".release-sub").click(function() {
                if (!personal.prototype.newPwd()) {
                    personal.prototype.layerFun("请输入新密码");
                    return false;
                }
                if (!personal.prototype.pwd()) {
                    personal.prototype.layerFun("请再次输入密码");
                    return false;
                }
                if (personal.prototype.pwd() != personal.prototype.newPwd()) {
                    personal.prototype.layerFun("密码不一致！");
                    return false;
                }
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: { // 这里写要传过去的参数
                        newPwd: personal.prototype.newPwd()
                    },

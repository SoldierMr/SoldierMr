    ...
    list.prototype = {
        ...
        range: (function() {
            $(".price-btn").click(function() {
                window.location.href = '/shop?district=' + $('#district').val() + '&region=' + $('#region').val() + '&line=' + $('#line').val() + '&station=' + $('#station').val() + '&rentstart=' + $('.rentstart').val() + '&rentend=' + $('.rentend').val() + '&squarestart=' + $('#squarestart').val() + '&squareend=' + $('#squareend').val() + '&characteristic=' + $('#characteristic').val() + '&search=' + $('#search').val();
            });
